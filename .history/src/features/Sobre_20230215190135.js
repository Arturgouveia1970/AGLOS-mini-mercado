    ...
    <div className={`${styles.sobreCtn} container-fluid max-vh-100`}>
      ...
      <div className={`${styles.sobreText}`}>
        ...
        <p className={`${styles.text}`}>
          ...
          local e arredores o acesso a uma variedade de alta qualidade de produtos locais e importados.
          Venha visitar-nos e um membro da nossa equipa ajudar-lhe-a a levar novos sabores e
