    ...
    <div className={`${styles.sobreCtn} container-fluid max-vh-100`}>
      ...
      <div className={`${styles.sobreText}`}>
        ...
        <p>
          ...
          local o acesso a uma variedade de alta qualidade de produtos nacionais e internacionais. Venha
          visitar-nos e um menbro da nossa equipa ajudá-lo-a a levar novos sabores e receitas para 
