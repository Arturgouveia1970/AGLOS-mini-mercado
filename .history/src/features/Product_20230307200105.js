  ...
  <>
    ...
    <div className={`${styles.productsText}`}>
      <div className={`${styles.carnesText}`}>
        ...
        <p>Nós temos uma variedade especial de cortes de carne, peixe e frango.</p>
      </div>
      <div className={`${styles.vegText}`}>
        <h2>Frutos e Vegetais</h2>
        <p>
          Especializamo-nos em frutas sazonais de fazendas locais.
      ...
      <div className={`${styles.especiaisText}`}>
        ...
        <p>
          ...
          de higiene pessoal e de casa num só lugar.
        </p>
      </div>
    </div>
    <Footer />
